...
export const CreateArticleForm = () => {
	...
	const articleToEdit = isEditing
		? userCreatedArticles.find(article => article.id === id)
		: undefined;
	...
	return (
		<div className={s.container}>
			...
			<form className={s.form} onSubmit={handleSubmit(onSubmit)}>
				...
				<div className={s.formGroup}>
					<label htmlFor="trailText" className={s.label}>Summary *</label>
					<Controller
						name="trailText"
						control={control}
						render={({ field }) => (
				...
				<div className={s.formGroup}>
					<label htmlFor="body" className={s.label}>Content *</label>
					<Controller
						name="body"
						control={control}
						render={({ field }) => (
